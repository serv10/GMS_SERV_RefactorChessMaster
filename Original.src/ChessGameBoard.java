...
public class ChessGameBoard extends JPanel{
    ...
    public void initializeBoard() {
        ...
        for (int i = 0; i < chessCells.length; i++) {
            for (int j = 0; j < chessCells[0].length; j++) {
                ...
                ChessGamePiece pieceToAdd = aniadirPiezas(i, j);
    ...
    public ChessGamePiece aniadirPiezas(int i, int j) {
        ...
        if (i == 1)
            ...
            return aniadirPiezasMayores(i, j, colNum);

        return null;
    }

    public ChessGamePiece aniadirPiezasMayores(int i, int j, int colNum) {
        if (j == 0 || j == 7)
